...
**Cursor スタイルの open-source Agent IDE — ただ速くコードを書くためだけでなく、レビューしやすさ、トレーサビリティ、制御のために作られています。**
...
<p align="center">
  <img src="../../assets/github-browser-demo.png" alt="ORGII GitHub ブラウザデモ" width="720" />
</p>

<p align="center">
  <img src="../../assets/agent-scheduling-demo.png" alt="ORGII Agent scheduling デモ" width="720" />
</p>
