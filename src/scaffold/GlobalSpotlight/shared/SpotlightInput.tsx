...
export const SpotlightInput: React.FC<SpotlightInputProps> = ({
  ...
  return (
    <div
      className="flex h-[56px] min-h-[56px] items-center gap-2 px-4"
      style={{ borderBottom: "1px solid rgba(var(--border-2-rgb), 0.5)" }}
    >
      ...
      <input
        ...
        className="min-w-0 flex-1 bg-transparent text-[16px] text-text-1 outline-none placeholder:text-text-2"
        autoFocus={autoFocus}
        autoComplete="off"
        spellCheck="false"
