...
| 5   | Search focus keeps dropdown  | Open dropdown with ≥ 5 worktrees                         | Dropdown stays open; search auto-focuses and accepts typing via `DropdownSearch` mousedown guard                                                          |
