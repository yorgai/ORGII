...
use crate::intelligence::mcp::config::{McpServerConfig, McpTransportType};
use crate::intelligence::mcp::handler::{AgentClientHandler, HandlerEvent};
use crate::intelligence::mcp::notification::ServerNotification;
...
impl McpClient {
    pub async fn connect(name: &str, config: &McpServerConfig) -> Result<Self, String> {
        ...
        crate::intelligence::mcp::env_expansion::expand_server_config(&mut expanded)
