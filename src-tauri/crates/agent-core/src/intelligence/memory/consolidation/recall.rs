...
use crate::intelligence::memory::embeddings::AutoEmbeddingProvider;
use crate::intelligence::memory::learnings::{self, Learning};
...
pub(super) async fn recall_mode_embedding(
    ...
    use crate::intelligence::memory::embeddings::EmbeddingProvider;
...
mod tests {
    ...
    fn search_similar_excludes_pending_rows() {
        ...
        let hits = crate::intelligence::memory::learnings::search_similar(
            &conn,
            scope,
            &[1.0_f32],
            Some("test"),
