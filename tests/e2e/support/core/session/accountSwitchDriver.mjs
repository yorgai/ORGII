...
const CODEX_INITIAL_ACCOUNT_NAME = process.env.E2E_CODEX_INITIAL_ACCOUNT;
const CODEX_FOLLOWUP_ACCOUNT_NAME = process.env.E2E_CODEX_FOLLOWUP_ACCOUNT;
const CURSOR_INITIAL_ACCOUNT_NAME =
  process.env.E2E_CURSOR_CLI_INITIAL_ACCOUNT ??
  process.env.E2E_CURSOR_ACCOUNT_A;
const CURSOR_FOLLOWUP_ACCOUNT_NAME =
